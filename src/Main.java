...
public class Main {
   ...
   static String[] menuItems = {"pizza", "salad", "chicken nuggets", "bread sticks", "steak"};
   ...
   public static void main(String[] args) {
       ...
       System.out.println("Hey there, welcome to The Classic Plate! I'm PlatePal. I can help you with the menu, "
           + "placing togo orders, and reserving seats. What can I do for you today? (if you want to quit type q)");


       while (true) {
           System.out.print("You're back at the main chat! What would you like to do?: (press 'q' anytime to exit)");
   ...
   public static void toGoOrder(Scanner in) {
       ...
       if (checkMenu(order)) {
           System.out.println("Great choice! You've ordered " + order + ". Please provide your address for delivery.");
